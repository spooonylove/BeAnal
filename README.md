...
[![Release Build](https://github.com/spooonylove/beanal/actions/workflows/release.yml/badge.svg)](https://github.com/spooonylove/beanal/actions/workflows/release.yml)
[![CI](https://github.com/spooonylove/beanal/actions/workflows/ci.yaml/badge.svg)](https://github.com/spooonylove/beanal/actions/workflows/ci.yaml)
...
1.  Clone the repository:
    ```bash
    git clone https://github.com/spooonylove/beanal.git
    cd beanal
    ```
