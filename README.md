...
> **Note:** This is a modern rewrite of the original [C#/WPF implementation](https://github.com/spooonylove/beanal-legacy), leveraging Rust and `egui` for lower latency and cross-platform compatibility.
